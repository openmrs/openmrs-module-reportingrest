 ...
 */
@Resource(name = RestConstants.VERSION_1 + ReportingRestController.REPORTING_REST_NAMESPACE + "/reportdefinition", supportedClass = ReportDefinition.class, supportedOpenmrsVersions = {
        "1.8.*", "1.9.*" })
public class ReportDefinitionResource extends MetadataDelegatingCrudResource<ReportDefinition> implements Searchable {
	...
	public String getCohort(ReportDefinition reportdef) throws Exception {
		if(reportdef.getBaseCohortDefinition()!=null){
