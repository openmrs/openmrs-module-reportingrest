...
@Resource(name = RestConstants.VERSION_1 + ReportingRestController.REPORTING_REST_NAMESPACE + "/reportprocessor",
        supportedClass = ReportProcessorConfiguration.class, supportedOpenmrsVersions = {"1.8.*", "1.9.*" })
public class ReportProcessorResource extends MetadataDelegatingCrudResource<ReportProcessorConfiguration> implements Searchable {
     ...
     */
    @Override
    public ReportProcessorConfiguration save(ReportProcessorConfiguration definition) {
     ...
     */
    @Override
    public void purge(ReportProcessorConfiguration definition,RequestContext context) throws ResponseException {
